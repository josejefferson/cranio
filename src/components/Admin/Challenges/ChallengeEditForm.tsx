      ...
      <Accordion allowToggle mt={5}>
        <AccordionItem>
          ...
          <AccordionPanel pb={4}>
            <FormField
              mt={2}
              label="Mensagem de preparação"
              name="preparationMessage"
              placeholder="O desafio já vai começar!"
            />

            <FormField
              mt={2}
              label="Mensagem de resposta correta"
              name="correctMessage"
              placeholder="Você respondeu corretamente! Continue assim."
            />

            <FormField
              mt={2}
              label="Mensagem de resposta incorreta"
              name="incorrectMessage"
              placeholder="Não fique triste, você deu o seu melhor! Volte amanhã."
            />

            <FormField
              mt={2}
              label="Mensagem de tempo esgotado"
              name="timeOutMessage"
              placeholder="Tic tac, o tempo acabou! Infelizmente você demorou muito e o relógio não parou. Amanhã você terá uma nova chance!"
            />
          </AccordionPanel>
        </AccordionItem>
      </Accordion>
